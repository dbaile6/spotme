...
import SearchResultArtist from './search-result-artist.js'
import SearchResultTrack from './search-result-track.js'
import SeedTypeControls from './seed-type-controls.js'
  ...
  render() {
    ...
    return (
      <form onSubmit={e => this.onSeedSearch(e)}>
        <h3 className="title is-3">Choose a starting point</h3>
